...
"""modified by lex 20161103, to move uvision project file into IoT-OS/projects"""
EXPORT_UVISION_DIR = abspath(join(ROOT, "..\IoT-OS\projects"))
#EXPORT_UVISION_DIR = None
...
def main():
    ...
    export(options.mcu, options.ide, build=options.build,
           ...
           zip_proj=zip_proj, options=options.opts, export_path=EXPORT_UVISION_DIR)
