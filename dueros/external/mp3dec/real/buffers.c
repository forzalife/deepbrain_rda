...
MP3DecInfo *AllocateBuffers(void)
{
	...
	mp3DecInfo = (MP3DecInfo *)MEDIA_MALLOC(sizeof(MP3DecInfo));
	if (!mp3DecInfo)
		return 0;
	ClearBuffer(mp3DecInfo, sizeof(MP3DecInfo));

	fh =  (FrameHeader *)     MEDIA_MALLOC(sizeof(FrameHeader));
	si =  (SideInfo *)        MEDIA_MALLOC(sizeof(SideInfo));
	sfi = (ScaleFactorInfo *) MEDIA_MALLOC(sizeof(ScaleFactorInfo));
	hi =  (HuffmanInfo *)     MEDIA_MALLOC(sizeof(HuffmanInfo));
	di =  (DequantInfo *)     MEDIA_MALLOC(sizeof(DequantInfo));
	mi =  (IMDCTInfo *)       MEDIA_MALLOC(sizeof(IMDCTInfo));
	sbi = (SubbandInfo *)     MEDIA_MALLOC(sizeof(SubbandInfo));
