...
public:
	...
	//zafter
	rda58xx_at_status setGPIOMode(int pin_name);
	rda58xx_at_status setGPIODir(int pin_name);
	rda58xx_at_status setGPIOVal(int pin_name, int val);
	rda58xx_at_status getGPIOVal(char *res,int *size, int pin_name);
	rda58xx_at_status btPlay(void);
	rda58xx_at_status btPause(void);
	rda58xx_at_status btBackWard(void);
	rda58xx_at_status btForWard(void);
    ...
    rda58xx_at_status startRecord(mci_type_enum ftype, uint16_t size, uint16_t sample_rate);
    ...
    rda58xx_at_status leGetConfigInfo(char *confinInfo);
    ...
    rda58xx_at_status SetName(const unsigned char* name);
    bool isReady(void);
    bool isPowerOn(void);
