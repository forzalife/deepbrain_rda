...
#define RT5670_MONO_DAC_MIXER			0x2b
...
#define RT5670_EQ_CTRL_MASK			(0x33fe)
...
typedef enum {
    BIT_LENGTH_16BITS = 0x00,
    BIT_LENGTH_20BITS = 0x01,
    BIT_LENGTH_24BITS = 0x02,
    BIT_LENGTH_8BITS = 0x03,
} BitsLength;
...
int rt5670WriteReg(uint8_t regAdd, uint16_t data);
