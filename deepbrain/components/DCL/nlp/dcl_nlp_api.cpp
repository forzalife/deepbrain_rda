	...
	DCL_NLP_HANDLE_t **nlp_handle)
{
	...
	*nlp_handle = (DCL_NLP_HANDLE_t *)memory_malloc(sizeof(DCL_NLP_HANDLE_t));
	...
	if (sock_get_server_info(DCL_NLP_API_URL, (char*)&http_buffer->domain, (char*)&http_buffer->port, (char*)&http_buffer->params) != 0)
	{
	...
	snprintf(http_buffer->req_body, sizeof(http_buffer->req_body),
		...
		"\"requestHead\":"
			...
			"\"apiAccount\":"
				...
				"\"userId\":\"%s\","
				"\"deviceId\":\"%s\"}},"
		"\"nlpData\":{\"inputText\":\"%s\"},\"simpleResponse\":true,\"simpleView\": false}",
