...
typedef enum WIFI_MANAGE_STATUS_t
{
	...
	WIFI_MANAGE_STATUS_AIRKISS = 0x2200,
	WIFI_MANAGE_STATUS_AIRKISS_ON,
	WIFI_MANAGE_STATUS_AIRKISS_OFF,
	WIFI_MANAGE_STATUS_AIRKISS_WAITING,
	WIFI_MANAGE_STATUS_AIRKISS_CONNECTING,
	WIFI_MANAGE_STATUS_AIRKISS_CONNECT_WAIT,
	WIFI_MANAGE_STATUS_AIRKISS_CONNECT_SUCCESS,
	WIFI_MANAGE_STATUS_AIRKISS_CONNECT_FAIL,
